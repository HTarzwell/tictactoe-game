...
var allSquares = function allSquares() {
  $('#squarezero').on('click', function () {
    gameOn.playToken();
    $('#squarezero').text(gameOn.playerToken);
    var spaceZero = $('#squarezero').text(); // build a function for array index + token
  ...
  $('#squarethree').on('click', function () {
    ...
    var spaceThree = $('#squarethree').text();
  ...
  $('#squareseven').on('click', function () {
    ...
    var spaceSeven = $('#squareseven').text();
  ...
  $('#squareeight').on('click', function () {
    ...
    var spaceEight = $('#squareeight').text();
...
/** const onUpdateGame = function (event) {
  ...
  console.log('made it to events onUpdateGame') // pr
  console.log('index data is', index.data) // pr 246
} **/
